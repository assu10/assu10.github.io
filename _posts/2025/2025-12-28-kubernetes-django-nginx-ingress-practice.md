...
```shell
assu@myserver01:~/work/ch10/ex01$ cd myDjango04/myapp/myapp
assu@myserver01:~/work/ch10/ex01/myDjango04/myapp/myapp$ ls
asgi.py  __init__.py  __pycache__  settings.py  urls.py  wsgi.py
```

```shell
assu@myserver01:~/work/ch10/ex01/myDjango04/myapp/myapp$ vim settings.py
```
...
```shell
assu@myserver01:~/work/ch10/ex01/myDjango04/myapp/myapp$ cd ../..
assu@myserver01:~/work/ch10/ex01/myDjango04$ ls
Dockerfile  myapp  requirements.txt

# 이미지 빌드(Tag: 0.2)
assu@myserver01:~/work/ch10/ex01/myDjango04$ docker image build . -t mydjango_ch10:0.2
...
assu@myserver01:~/work/ch10/ex01/myDjango04$ docker image ls
...
```shell
assu@myserver01:~/work/ch10/ex01/myDjango04$ docker login
...
assu@myserver01:~/work/ch10/ex01/myDjango04$ docker tag mydjango_ch10:0.2 assu/mydjango_ch10:0.2

# 도커 허브에 업로드
assu@myserver01:~/work/ch10/ex01/myDjango04$ docker push assu/mydjango_ch10:0.2
