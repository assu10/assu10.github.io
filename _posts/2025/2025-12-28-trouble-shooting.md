...
```shell
assu@myserver01:~/work/ch10/ex01/myDjango04$ docker info | grep Username
 Username: real_id
```
...
```shell
assu@myserver01:~/work/ch10/ex01/myDjango04$ docker tag mydjango_ch10:0.2 real_id/mydjango_ch10:0.2
assu@myserver01:~/work/ch10/ex01/myDjango04$ docker push real_id/mydjango_ch10:0.2
```
