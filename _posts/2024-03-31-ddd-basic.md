...
* [4. 엔티티와 밸류](#4-엔티티와-밸류)
  ...
  * [4.3. 밸류 타입](#43-밸류-타입)
      * [4.3.1.1. 원시 집착 코드 징후(Primitive obsession code smell)](#4311-원시-집착-코드-징후primitive-obsession-code-smell)
  ...
  * [4.5. 도메인 모델에서 set 메서드 넣지 않기](#45-도메인-모델에서-set-메서드-넣지-않기)
...
따라서 아래처럼 _id_ 와 같은 필드는 불필요할 뿐 아니라 실제로 버그를 발생시킬 수 있다.
...
#### 4.3.1.1. 원시 집착 코드 징후(Primitive obsession code smell)
