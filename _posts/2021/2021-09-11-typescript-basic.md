...
<!-- TOC -->
  * [1. 타입스크립트](#1-타입스크립트)
  * [2. 타입스크립트 문법](#2-타입스크립트-문법)
    * [2.1. 타입 주석과 타입 추론](#21-타입-주석과-타입-추론)
    * [2.2. 인터페이스](#22-인터페이스)
    * [2.3. 튜플](#23-튜플)
    * [2.4. 제네릭 타입](#24-제네릭-타입)
    * [2.5. 대수 타입 (ADT)](#25-대수-타입-adt)
  * [3. 타입스크립트 셋팅](#3-타입스크립트-셋팅)
    * [3.1. 타입스크립트 설치](#31-타입스크립트-설치)
  * [4. 타입스크립트 프로젝트 생성](#4-타입스크립트-프로젝트-생성)
    * [4.1. tsconfig.json](#41-tsconfigjson)
    * [4.2. 프로젝트 구조 생성](#42-프로젝트-구조-생성)
    * [4.3. 모듈 (export, import)](#43-모듈-export-import)
