...
이 포스팅은 Docker 를 알아보기 전 알아야 할 시스템/인프라 기초 지식에 대해 기술한다. (아주 간략히)
...
리눅스 디렉토리는 FHS (Filesystem Hierarchy Standard) 라는 규격에 의해 표준화되어 있다.
...
- 리눅스 주요 디렉토리
    ...
    - /etc
        ...
        - 웹 서버 시작 시 http 데몬 설정 파일도 해당 디렉토리에 배치
    - /home
        - 사용자 홈 디렉토리
    - /lib
        - 공유 라이브러리
