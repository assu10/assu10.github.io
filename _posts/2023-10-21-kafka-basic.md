...
> key, value 에 대한 좀 더 상세한 내용은 추후 다룰 예정입니다.
...
> 스키마와 직렬화에 대한 좀 더 상세한 내용은 추후 다룰 예정입니다.
...
각 파티션이 서로 다른 서버에 저장될 수 있으며, 파티션은 복제될 수 있다. 즉, 서로 다른 서버들이 동일한 파티션의 복제본을 저장하고 있기 때문에 서버 중 하나에 장애가 발생하더라도 
