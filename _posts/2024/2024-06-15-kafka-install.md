...
- **각 서버는 공통된 설정 파일을 사용**해야 함
  - 이 설정 파일에는 앙상블에 포함된 모든 서버의 목록이 포함되어 있음
...
> 관리용 툴에 대한 내용은  
> [Kafka - 운영(1): 토픽 작업, 컨슈머 그룹 작업, 동적 설정 변경](https://assu10.github.io/dev/2024/09/21/kafka-operation-1/),  
> [Kafka - 운영(2): 파티션 관리](https://assu10.github.io/dev/2024/09/22/kafka-operation-2/)  
> 를 참고하세요.
...
> 위 내용에 대한 상세한 내용은 [1.5. 파티션 개수 줄이기](https://assu10.github.io/dev/2024/09/21/kafka-operation-1/#15-%ED%8C%8C%ED%8B%B0%EC%85%98-%EA%B0%9C%EC%88%98-%EC%A4%84%EC%9D%B4%EA%B8%B0) 를 참고하세요.
...
> 
> 위 내용의 좀 더 상세한 내용은 [Kafka - 운영(2): 파티션 관리](https://assu10.github.io/dev/2024/09/22/kafka-operation-2/) 를 참고하세요.
...
> 복제 팩터 증가에 대한 부분은 [3.1. 복제 팩터(레플리카 개수): `replication.factor`, `default.replication.factor`](https://assu10.github.io/dev/2024/08/17/kafka-reliability/#31-%EB%B3%B5%EC%A0%9C-%ED%8C%A9%ED%84%B0%EB%A0%88%ED%94%8C%EB%A6%AC%EC%B9%B4-%EA%B0%9C%EC%88%98-replicationfactor-defaultreplicationfactor) 를 참고하세요.
