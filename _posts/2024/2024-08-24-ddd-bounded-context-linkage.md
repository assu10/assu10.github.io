...
* [3. 분리형 노선(Separated Ways): 협업 대신 각자의 길을 선택](#3-분리형-노선seperated-ways-협업-대신-각자의-길을-선택)
...
# 3. 분리형 노선(Separated Ways): 협업 대신 각자의 길을 선택
...
- **DRY(Don't Repeat Yourself) 위반**
 ...
 - 다른 2개의 컨텍스트에서 '정책'에 관한 모델을 생성하는 것은 서로 다른 모델에 있는 코드의 일부 측면이 유사하더라도 DRY 를 위반하는 것이 아님
