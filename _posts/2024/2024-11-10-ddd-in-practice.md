...
일반적으로 [스트랭글러 패턴](https://assu10.github.io/dev/2025/06/22/architecture-monolith-to-msa-transition/#33-%EC%8A%A4%ED%8A%B8%EB%9E%AD%EA%B8%80%EB%9F%ACstrangler-%ED%8C%A8%ED%84%B4)은 [퍼사드](https://assu10.github.io/dev/2024/12/15/facade/) 패턴(facade pattern) 과 함께 사용된다.  
