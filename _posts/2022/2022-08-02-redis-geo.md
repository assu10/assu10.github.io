...
이 포스팅은 Redis 의 데이터 타입 중 하나인 `Geo` 타입에 대해 알아본다.
...
>   - [`GEOPOS`](#12-geopos)
>   - [`GEODIST`](#13-geodist)
>   - [`GEORADIUSBYMEMBER`, `GEORADIUS`](#14-georadiusbymember-georadius)
>      - [`WITHCOORD`](#141-withcoord)
>      - [`WITHDIST`](#142-withdist)
>      - [`WITHHASH`](#143-withhash)
>      - [`COUNT`](#144-count)
>      - [`ASC`/`DESC`](#145-ascdesc)
>      - [`STORE`](#146-store)
>   - [`GEOHASH`](#15-geohash)
>   - [`ZRANGE`, `ZREM`, `ZCARD`](#16-zrange-zrem-zcard)
