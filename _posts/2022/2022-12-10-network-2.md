...
- **Dynamic Routing**
  ...
  - 네트워크 정보를 수동으로 설정할 필요 없이 동적으로 네트워크 정보 관리 가능
...
해당 Endpoint 에서 암호화된 사용자 트래픽을 복호화하여 AWS 내의 리소스와 통신이 가능하다.
...
① aaIDC-EC2 Instance (10.60.1.100) 에서 aaAWS-EC2 Instance (10.50.1.100) 으로 ping 패킷 전송  
