...
* [3. 상세 설계](#3-상세-설계)
  * [3.1. 중요 구성요소별 규모 확장성](#31-중요-구성요소별-규모-확장성)
    * [3.1.1. API 서버](#311-api-서버)
    * [3.1.2. 웹소켓 서버](#312-웹소켓-서버)
    * [3.1.3. 클라이언트 초기화](#313-클라이언트-초기화)
    * [3.1.4. 사용자 DB](#314-사용자-db)
    * [3.1.5. 위치 정보 캐시](#315-위치-정보-캐시)
    * [3.1.6. 레디스 펍/섭 서버](#316-레디스-펍섭-서버)
    * [3.1.7. 얼마나 많은 레디스 펍/섭 서버가 필요할까?](#317-얼마나-많은-레디스-펍섭-서버가-필요할까)
    * [3.1.8. 분산 레디스 펍/섭 클러스터](#318-분산-레디스-펍섭-클러스터)
    * [3.1.9. 레디스 펍/섭 서버 클러스터 규모 확장 시 고려사항](#319-레디스-펍섭-서버-클러스터-규모-확장-시-고려사항)
    * [3.1.10. 운영 고려사항](#3110-운영-고려사항)
  * [3.2. 친구 추가/삭제](#32-친구-추가삭제)
  * [3.3. 친구가 많은 사용자](#33-친구가-많은-사용자)
  * [3.4. 주변의 임의 사용자](#34-주변의-임의-사용자)
  * [3.5. 레디스 펍/섭 외의 대안](#35-레디스-펍섭-외의-대안)
* [4. 마무리](#4-마무리)
* [요약](#요약)
...
Stateless 상태인 RESTful API 서버의 규모 확장 방법은 이미 널리 알려져 있다.
...
### 3.1.7. 얼마나 많은 레디스 펍/섭 서버가 필요할까?

---

### 3.1.8. 분산 레디스 펍/섭 클러스터

---

### 3.1.9. 레디스 펍/섭 서버 클러스터 규모 확장 시 고려사항
