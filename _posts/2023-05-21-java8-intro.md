...
Java8 에는 Stream API 가 추가되었는데 단순히 어떤 항목을 연속으로 제공하는 어떠한 기능이라고 생각하면 된다.
...
> 동작 파라메터화는 [Java8 - 동작 파라메터화](https://assu10.github.io/dev/2023/05/27/java8-behavior-parameterization/) 를 참고하세요.
