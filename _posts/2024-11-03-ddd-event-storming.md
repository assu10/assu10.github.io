...
- 이벤트 스토밍에는 '도전적 평범함'이 필요함
  - 이벤트 스토밍 세션에는 단순히 기술적인 사람 뿐 아나리 명백한 질문에 답할 수 있는 사람, 기꺼이 평범한 가정을 뒤집을 자세가 되어있는 비즈니스 및 기술 전문가가 함께 해야함
...
외부 시스템이란 현재 탐색 중인 도메인에 직접 포함되지 않은 시스템을 의미힌다.  
