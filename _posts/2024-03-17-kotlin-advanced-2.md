---
layout: post
title: "Kotlin - 제네릭스(1): Any, 타입 정보 보존, 제네릭 확장 함수, 타입 파라메터 제약, 타입 소거"
date: 2024-03-17
categories: dev
...
> 이에 대한 내용은 [1.1. `reified` 를 사용하여 `is` 를 제네릭 파라메터에 적용](https://assu10.github.io/dev/2024/03/18/kotlin-advanced-2-1/#11-reified-%EB%A5%BC-%EC%82%AC%EC%9A%A9%ED%95%98%EC%97%AC-is-%EB%A5%BC-%EC%A0%9C%EB%84%A4%EB%A6%AD-%ED%8C%8C%EB%9D%BC%EB%A9%94%ED%84%B0%EC%97%90-%EC%A0%81%EC%9A%A9) 을 참고하세요.
